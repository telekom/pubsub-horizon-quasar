...
| store.hazelcast.hcconnectionstrategy.Timeout                | QUASAR_HAZELCAST_HCCONNECTIONSTRATEGY_TIMEOUT                | string        | 10m                       | Timeout for Hazelcast connection strategy.                                                                         |
| store.hazelcast.hcConnectionstrategy.hcRetry.initialbackoff | QUASAR_HAZELCAST_HCCONNECTIONSTRATEGY_HCRETRY_INITIALBACKOFF | string        | 1s                        | Initial backoff for Hazelcast reconnection retries.                                                                |
| store.hazelcast.hcConnectionstrategy.hcRetry.jitter         | QUASAR_HAZELCAST_HCCONNECTIONSTRATEGY_HCRETRY_JITTER         | int           | 0.0                       | Jitter factor for Hazelcast reconnection retries.                                                                  |
| store.hazelcast.hcConnectionstrategy.hcRetry.maxbackoff     | QUASAR_HAZELCAST_HCCONNECTIONSTRATEGY_HCRETRY_MAXBACKOFF     | string        | 10s                       | Maximum backoff for Hazelcast reconnection retries.                                                                |
| store.hazelcast.hcConnectionstrategy.hcRetry.multiplier     | QUASAR_HAZELCAST_HCCONNECTIONSTRATEGY_HCRETRY_MULTIPLIER     | int           | 1.2                       | Multiplier for backoff increase on Hazelcast reconnection.                                                         |
