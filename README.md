...
| store.hazelcast.maxRetries                              | QUASAR_HAZELCAST_MAXRETRIES                              | int           | 0                         | Controls how many times the client will retry connecting to the Hazelcast cluster on start up before giving up. 0 means endless. |
