...
| watcher.enabled                                         | QUASAR_WATCHER_ENABLED                                   | bool          | true                      | Whether or not the watcher should be enabled.                                                                      |
...
| provisioning.enabled                                    | QUASAR_PROVISIONING_ENABLED                              | bool          | true                      | Whether or not the provisioning API should be enabled.                                                             |
